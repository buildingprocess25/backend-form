...
const emailTemplates = {
  ...
  "materai_upload": {
    getSubject: (data) =>
      `Dokumen Final RAB & SPH Penawaran Termaterai - ${data.ulok}`,
    getRecipients: (data) => data.recipients || [],
    getHtmlBody: (data) => {
      const sapaanNama =
      ...
      const hasRab = !!data.rabUrl;
      const hasSph = !!data.sphUrl;
      ...
      <div style="font-family: Arial, sans-serif; line-height: 1.6;">
        ...
        <ul>
          ${
            hasRab
              ? `<li>📄 <a href="${data.rabUrl}" target="_blank">Rekapitulasi RAB Termaterai</a></li>`
              : ""
          }
          ${
            hasSph
              ? `<li>📄 <a href="${data.sphUrl}" target="_blank">SPH Termaterai</a></li>`
              : ""
          }
        </ul>
